...
class ActiveCircle:
    ...
    def __init__(self):
        ...
        self.locationSX = random.randint(0, width) 
        self.locationSY = random.randint(0, height) 
    ...
    def draw(self):
        ...
        pygame.draw.line(screen, self.color, (self.locationSX, self.locationSY), (self.locationEX, self.locationEY), random.randint(1, 3))
